...
public class SFTPClient extends ModelCommandProcessor implements AutoCloseable {
	...
	public void connect() throws Exception {
		...
		kn0 = credentials.getKn0(); kn1 = credentials.getKn1(); kn2 = credentials.getKn2();
	...
	public boolean exists(String file) {
	    ...
	    try {
	        ...
	        logger.error("Unexpected exception during ls files on sftp: " + file, e);
	...
	public void createPath(String path, boolean forceUploadsFolderAsRoot) throws Exception {
		if (path!=null) {
			...
			logger.debug("path to root: " + root);
			sftp.cd(root);
