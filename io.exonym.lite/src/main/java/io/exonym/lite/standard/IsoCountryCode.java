...
public class IsoCountryCode {
    ...
    public boolean isCountryCode(String isoCode){
        return country.containsKey(isoCode.toUpperCase());

    }

    public String getCountry(String isoCode){
    ...
    public static IsoCountryCode getInstance(){
        return instance;
    }
}