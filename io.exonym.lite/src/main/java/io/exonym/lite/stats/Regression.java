...
public class Regression {
	   ...
	   public static void main(String argv[]) {
	      ...
	      double coef[] = leastSquares(rawData, 1);
	      print_equation(coef);
	      ...
	      print_equation(leastSquares(rawData, 2));
	      ...
	      print_equation(leastSquares(rawData, 3));
	   ...
	   * requested equation order (n-order) plus 1. 
	   **/
	   
	   public static double[] leastSquares(double rawData[][], int norder) {
		   if (rawData==null){
			   return null; 
		   }
	   ...
	   static double[] gauss(double ax[][], double bx[]) {
	      ...
	      // copy over the array values - in-place solution changes values
