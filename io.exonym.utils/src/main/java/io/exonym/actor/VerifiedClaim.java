...
import io.exonym.abc.attributeEncoding.*;
...
public class VerifiedClaim {
	...
	public URI claimUri(String internal) {
		...
		uri += ":" + credSpec.getSpecificationUID().toString()
			.replaceAll(NamespaceMngt.URN_PREFIX_COLON, "");
		uri += ":" + internal;
		return URI.create(NamespaceMngt.URN_PREFIX_COLON + uri);
		
	}	
	
	protected ArrayList<Attribute> commitToDefinedAttributes() throws Exception {
