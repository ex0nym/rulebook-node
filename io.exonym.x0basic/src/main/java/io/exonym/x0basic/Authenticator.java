...
public class Authenticator {
    ...
    protected static void authenticateAckAndSource(ExoNotify notify, AsymStoreKey hostKey) throws Exception {
    ...
    private static void verify(byte[] toSign, ExoNotify notify, AsymStoreKey hostKey) throws Exception {
        logger.debug(notify.getAdvocateUID() + " using Key " + hostKey.getPublicKeyB64());
